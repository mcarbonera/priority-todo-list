...
class NewVisitorTest(LiveServerTestCase):
	...
	def test_priority_todo(self):
		...
		inputCheck1 = self.browser.find_element(By.ID, 'id_prioridade_baixa')
		inputCheck2 = self.browser.find_element(By.ID, 'id_prioridade_media')
		inputCheck3 = self.browser.find_element(By.ID, 'id_prioridade_alta')
		inputCheck1.send_keys(Keys.CLICK)
		print(inputCheck1.checked)
		print(inputCheck2.checked)
		print(inputCheck3.checked)
		inputCheck1.check
